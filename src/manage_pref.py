...
class ManagePreferences:
    ...
    def open_preferences_window(self):
        ...
        self.preferences_window.iconbitmap('VerifyVaultLogo.ico')
    ...
    def open_automatic_backups_window(self):
        ...
        automatic_backups_window.iconbitmap('VerifyVaultLogo.ico')
        ...
        self.toggle_button_text.set("Automatic Backups are ON" if self.automatic_backups_enabled else "Automatic Backups are OFF")
    ...
    def open_customize_window(self):
        ...
        self.customize_window.iconbitmap('VerifyVaultLogo.ico')
    ...
    def save_preferences(self):
        ...
        # Update existing preferences or add new sections
