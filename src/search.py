...
class SearchFunctions:
    def __init__(self, master, search_var, update_labels, top_button_frame, key):
        ...
        self.search_entry = tk.Entry(self.top_button_frame, textvariable=self.search_var, width=40, bd=7,
    ...
    #Function that removes the search bar placeholder
    def remove_placeholder(self, event):
        if self.search_var.get() == "Search...":
            self.search_var.set("")

    # Function that sets the search funtionality
    ...
    #Function that adds the placeholder back
    ...
    # Function that disiplays relevant accounts
