...
class MenuManager:
    def __init__(self, master):
        ...
        self.social_menu.add_command(label="Hacker News", command=self.copy_hackernews_url)
        ...
        self.socials_menu.add_cascade(label="Social", menu=self.social_menu)
    ...
    def copy_matrix_url(self):
        ...
        webbrowser.open(url)
    def copy_hackernews_url(self):
        url = "https://news.ycombinator.com/submitted?id=VerifyVault"
        webbrowser.open(url)
