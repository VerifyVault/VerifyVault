...
class MenuManager:
    ...
    # Function to configure the Guides tab
    def show_basic_functionality(self):
        ...
        basic_functionality_window.iconbitmap('VerifyVaultLogo.ico')
    ...
    # Function to configure the Add Account Help tab
    def add_account_help(self):
        ...
        add_account_help.iconbitmap('VerifyVaultLogo.ico')
    ...
    # Function to configure the Edit Account Help tab
    def edit_help(self):
        ...
        edit_help.iconbitmap('VerifyVaultLogo.ico')
    ...
    # Function to configure the Password Help tab
    def password_help(self):
        ...
        password_help.iconbitmap('VerifyVaultLogo.ico')
    ...
    # Function to configure the Manage Data Help tab
    def data_help(self):
        ...
        data_help.iconbitmap('VerifyVaultLogo.ico')
    ...
    # Function to configure the Manage Preferences Help tab
    def pref_help(self):
        ...
        pref_help.iconbitmap('VerifyVaultLogo.ico')
    ...
    # Function to configure the Common Errors tab
    def common_errors(self):
        ...
        common_errors.iconbitmap('VerifyVaultLogo.ico')
