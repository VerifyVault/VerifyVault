...
class EditAccount:
    def __init__(self, master, key, accounts, notifications):
        # edit_accout_tab constructor
        self.master = master
        self.key = load_key()
        self.accounts = accounts
        self.notifications = notifications
        self.active_window = None
        master.iconbitmap('VerifyVaultLogo.ico')
    ...
    def edit_account(self, name):
        ...
        # Edit Name Function
        def edit_name():
        # Edit Account Name window configurations
            ...
            edit_name_window.iconbitmap('VerifyVaultLogo.ico')
            ...
            # Function to validate that the account name
            ...
            # Function to update the name character counter
        ...
        def delete_account():
            ...
            # Function to add the account to the recycle bin
