...
class LabelsManager:
    ...
    # Function that retrievs the accounts
    def get_accounts(self):
        return self.accounts
        
    # Function that displays the TOTP Copied notification
    ...
    def update_labels(self, accounts=None):
        ...
        if not accounts:
            ...
            # Function that opens the account information when clicked
            def click_account(name):
                ...
                # Function that updates TOTP Code and timer
                def update_timer():
            ...
            # Functions that handle mouse enter and leave events
            def on_enter(event):
