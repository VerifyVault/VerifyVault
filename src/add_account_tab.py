...
class AddAccountTab:
    ...
    # Funtion to close the current active window
    ...
    def add_account(self):
        # Add Account window configurations
        ...
        name_window.iconbitmap('VerifyVaultLogo.ico')
        ...
        # Funtion to validate the account name
        ...
        # Function to count the number of characters in the account name 
        ...
        # Funtion to check if the account name already exists
        def add_account_callback():
            name = name_entry.get().strip()
            if name:
                if name in self.accounts:
                    override = messagebox.askyesnocancel("Override Account", f"An account with the name '{name}' already exists. Do you want to override it?")
                    if override is True:
                ...
                key_window.iconbitmap('VerifyVaultLogo.ico')
                ...
                # Function to validate the key and add the account
                def confirm_account():
