...
class TwoFactorAppGUI:
    def __init__(self, master, key):
        ...
        self.labels_manager = LabelsManager(master, self.canvas, self.secframe, self.accounts, self.scrollbar, self.import_data, self.notifications, self.on_mousewheel, self.accounts_frame, self.add_account_tab)
        self.update_labels()
