...
class MenuManager:
    ...
    def copy_reddit_url(self):
        url = "https://www.reddit.com/user/VerifyVault/"
        webbrowser.open(url)
    ...
    def copy_matrix_url(self):
        url = "https://matrix.to/#/#verifyvault:matrix.org"
        webbrowser.open(url)

    def copy_twitter_url(self):
        url = "Coming Soon"
        pyperclip.copy(url)
        self.notifications.show_notification("Twitter URL copied to clipboard!")
    ...
    def show_basic_functionality(self):
        ...
        label = tk.Label(basic_functionality_window, text=text, justify="left", font=("Helvetica", 12))
    ...
    def add_account_help(self):
        ...
        label = tk.Label(add_account_help, text=text, justify="left", font=("Helvetica", 12))
        label.pack(padx=10, pady=10)
    ...
    def settings_help(self):
        ...
        label = tk.Label(settings_help, text=text, justify="left", font=("Helvetica", 12))
        label.pack(padx=10, pady=10)
    ...
    def edit_help(self):
        ...
        label = tk.Label(edit_help, text=text, justify="center", font=("Helvetica", 12))
        label.pack(padx=10, pady=10)
    ...
    def common_errors(self):
        ...
        label = tk.Label(common_errors, text=text, justify="center", font=("Helvetica", 12))
        label.pack(padx=10, pady=10)
